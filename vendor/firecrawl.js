...
var package_SYKCM5JT_exports = {};
__export(package_SYKCM5JT_exports, {
  default: () => package_SYKCM5JT_default
});
var package_SYKCM5JT_default;
var init_package_SYKCM5JT = __esm({
  "node_modules/@mendable/firecrawl-js/dist/package-SYKCM5JT.js"() {
    init_process_shim();
    init_chunk_J3BEBX3Y();
    package_SYKCM5JT_default = require_package();
  }
});
...
var FirecrawlApp = class {
  ...
  async getVersion() {
    try {
      ...
      const packageJson = await Promise.resolve().then(() => (init_package_SYKCM5JT(), package_SYKCM5JT_exports));
  ...
  postRequest(url, data, headers) {
    return axios_default.post(url, data, { headers, timeout: data?.timeout ? data.timeout + 5e3 : void 0 });
  }
  /**
